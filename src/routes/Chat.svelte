...
<div class="flex flex-col space-y-1.5 pb-6">
	...
	<p class="text-sm leading-3 text-[#6b7280]">Powered by Mendable and Vercel</p>
</div>

<!-- Chat Container -->
<div class="h-[474px] pr-4" style="min-width: 100%; display: table;">
	<!-- Chat Message AI -->
	...
	<div class="my-4 flex flex-1 gap-3 text-sm text-gray-600">
		...
		<p class="leading-relaxed">
			<span class="block font-bold text-gray-700">AI </span>Sorry, I couldn't find any information
			in the documentation about that. Expect answer to be less accurateI could not find the answer
